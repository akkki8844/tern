...
describe("PullRequestReport", () => {
  it("renders a complete PR body", () => {
    ...
    const usages: AffectedUsage[] = [{ id: "u1", file: "client.ts", line: 1, column: 1, functionName: "createCharge", snippet: "source", contextBefore: "", contextAfter: "", confidence: "high", breakingChangeId: "c1" }];
